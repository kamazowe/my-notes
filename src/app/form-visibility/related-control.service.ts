...
import { RelatedControl } from 'src/app/form-visibility/related-control';
import { VisibilityConditionService } from 'src/app/form-visibility/VisibilityCondition.service';
...
export class RelatedControlService {
  ...
  private addRelatedControl(related): void {
